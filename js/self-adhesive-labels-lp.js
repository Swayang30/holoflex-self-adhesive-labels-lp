/* ==========================================================================
   Holoflex — Self-Adhesive Labels landing page + thank-you page
   /js/self-adhesive-labels-lp.js

   Vanilla JS, no dependencies. Loaded with `defer` on both
   /self_adhesive_labels/ (index.html) and thank-you-lp.html. Sections that need elements
   ...
   GTM dataLayer events pushed by this file:
     enquiry_form_submit     THANK-YOU PAGE ONLY. { page_id: "self-adhesive-labels",
...
(function () {
  ...
  var ENDPOINT = 'submit-enquiry.php';       // relative: the page lives in a sub-folder (/self_adhesive_labels/)
  var THANK_YOU_URL = 'thank-you-lp.html';
  var PAGE_ID = 'self-adhesive-labels';     // must match LP_PAGE_ID in submit-enquiry.php
