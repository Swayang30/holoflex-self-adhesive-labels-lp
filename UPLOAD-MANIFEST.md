...
Total: 19 files. Keep the folder structure exactly as above — every path in
...
The page ships with neutral `.lp-ph` placeholder tiles. Each slot has the
...
|---|---|---|
| Core block product figure | `lp-label-materials-460`, `-920` | 460×287, 920×574 |
